...
\begin{figure}[H]
  \centering
  \includegraphics[width=9cm, height=4cm]{chapter3-architecture-web-service.png}
...
\begin{table}[H]
    ...
    \begin{tabular}{ |P{4cm}|p{10cm}| }
	  \hline
	  \rowcolor{indigo-dark} \multicolumn{2}{|c|}{ \textcolor{white}{\textbf{Plan de Iteraciones}}} \\
	  \hline
	  \rowcolor{indigo-light} \textbf{Iteración} & \centering \textbf{Objetivos}
	  \tabularnewline \hline
	  \multirow{5}{*}{1} & - Desarrollar el módulo de pedidos. \\
	  ...
	  \tabularnewline \hline
	   \multirow{4}{*}{2} & - Desarrollar el módulo de transacciones. \\
...
& - Automatizar la instalación de entornos de desarrollo.  
	  \tabularnewline \hline
	\multirow{2}{*}{3} & - Desarrollar el módulo de Usuarios \\
