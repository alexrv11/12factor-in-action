...
\begin{figure}[ht]
  \centering
  \includegraphics[width=15cm, height=7cm]{chapter1-aup-stages.png}
  \caption{Ciclo de vida Del Proceso Unificado Agil [CITATION Sco14 \l 1033 ]}  
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=15cm, height=7cm]{chapter1-model-12factor-aup.png}
  \caption{12factor introducida en las disciplinas de AUP (Elaboración propia)}  
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=15cm, height=7cm]{chapter1-model-process-development.png}
